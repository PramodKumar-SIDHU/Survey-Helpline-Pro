...
<qgis version="3.24.1-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="0">
  <renderer-v2 type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{f1b5a4ff-570a-4066-a941-5f89d267a6ec}">
      <rule symbol="0" key="{e9103bf8-df87-44c7-a9dd-8eea16f25a00}" filter=" &quot;PAR_REF_Built&quot;  = regexp_substr(@atlas_pagename, '^[^_]+')"/>
      ...
      <symbol type="fill" name="1" clip_to_extent="1" force_rhr="0" alpha="1">
        ...
        <layer locked="0" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
            <Option type="QString" name="align_dash_pattern" value="0"/>
            <Option type="QString" name="capstyle" value="square"/>
            <Option type="QString" name="customdash" value="3;5"/>
            <Option type="QString" name="customdash_map_unit_scale" value="3x:0,0,0,0,0,0"/>
            <Option type="QString" name="customdash_unit" value="MM"/>
            <Option type="QString" name="dash_pattern_offset" value="0"/>
            <Option type="QString" name="dash_pattern_offset_map_unit_scale" value="3x:0,0,0,0,0,0"/>
