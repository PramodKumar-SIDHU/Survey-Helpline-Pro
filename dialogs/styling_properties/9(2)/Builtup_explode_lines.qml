...
<qgis version="3.24.1-Tisler" styleCategories="Symbology|Labeling" labelsEnabled="1">
  <renderer-v2 type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0" enableorderby="0">
    <rules key="{75aa2b46-4865-4512-b670-56081ff12af6}">
      <rule symbol="0" key="{b267f887-653e-45d8-ae2d-9265919c78df}" description="hide_ppm" filter=" &quot;PAR_REF&quot;  = regexp_substr(@atlas_pagename, '^[^_]+')"/>
    </rules>
    <symbols>
      <symbol type="line" name="0" clip_to_extent="1" force_rhr="0" alpha="0">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" blendMode="0" fieldName="' (' || &quot;length&quot; || ') '" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOpacity="1" fontFamily="Arial" textOrientation="horizontal" namedStyle="Regular" fontWeight="50" fontItalic="0" fontLetterSpacing="0" fontWordSpacing="0" fontStrikeout="0" fontUnderline="0" textColor="255,0,0,255" capitalization="0" isExpression="1" useSubstitutions="0" multilineHeight="1" legendString="Aa" allowHtml="0" fontSize="10" fontSizeUnit="Point">
        <families/>
        ...
        <background shapeDraw="1" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeOpacity="0.50900000000000001" shapeBlendMode="0" shapeRadiiX="0" shapeRotation="0" shapeSizeX="0" shapeOffsetUnit="Point" shapeBorderColor="128,128,128,255" shapeBorderWidthUnit="Point" shapeJoinStyle="64" shapeSVGFile="" shapeOffsetY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeSizeUnit="Point" shapeRadiiY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeBorderWidth="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiUnit="Point" shapeType="0" shapeSizeType="0" shapeRotationType="0">
      ...
      <text-format autoWrapLength="0" decimals="3" plussign="0" useMaxLineLengthForAutoWrap="1" multilineAlign="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" reverseDirectionSymbol="0" placeDirectionSymbol="0" addDirectionSymbol="0" formatNumbers="0" wrapChar=""/>
      <placement overrunDistanceUnit="MM" dist="0" overrunDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" preserveRotation="1" placement="2" rotationUnit="AngleDegrees" polygonPlacementFlags="2" distUnits="MM" offsetType="0" lineAnchorPercent="0.5" lineAnchorClipping="0" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placementFlags="6" offsetUnits="MM" lineAnchorType="0" maxCurvedCharAngleOut="-25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" priority="6" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" geometryGeneratorEnabled="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" centroidWhole="0" maxCurvedCharAngleIn="25" repeatDistance="0" quadOffset="4" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" yOffset="0" layerType="LineGeometry"/>
